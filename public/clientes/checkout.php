...
$total = $subtotal; // sumar envío/recargos si aplica
      ...
      <div class="card"><div class="p">
        <?php foreach($items as $it): ?>
          <div class="row" style="align-items:flex-start;margin-bottom:10px">
            <img src="<?= h($it['img']) ?>" alt="" width="90" height="90" style="border-radius:8px;object-fit:cover">
            <div style="flex:1">
        ...
        <div style="margin-top:10px;text-align:right">
          <a class="cta" href="<?= urlc('carrito.php') ?>">Volver al carrito</a>
          <a class="cta" href="<?= urlc('pago.php') ?>">Pagar</a>
        </div>
      </div></div>
    <?php endif; ?>
  </div>
