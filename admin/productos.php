...
if ($_SERVER['REQUEST_METHOD']==='POST' && ($_POST['__action']??'')==='create_product') {
  try {
    ...
    // Tipos: i s s s s d i d  => "isssssid"
...
// Listado
$rows = $conexion->query("
  SELECT p.id,p.name,p.image_url, v.sku, v.size, v.color, v.measure_text, v.price, v.stock
  FROM products p
...
<html lang="es"><head>
  ...
  <header class="hero"><div class="container">
    ...
    <p>Cargá y visualizá los artículos de tu tienda.</p>
  </div></header>
  ...
  <main class="container">
    ...
    <?php else: ?>
      <div class="card" style="padding:14px"><div class="p">
        <b>No hay productos cargados aún.</b><br>
